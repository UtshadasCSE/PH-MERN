            ...
            <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
              <div className="max-w-md w-full p-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  {errors.email && (
                    <span className="text-error">This field is requiired!</span>
                  )}
                  <div>
                    <label
                      htmlFor="password"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full bg-[#F72585] text-[#7209B7] p-2 rounded-md hover:bg-gray-800 focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300"
                    >
                      Sign In
                    </button>
                  </div>
